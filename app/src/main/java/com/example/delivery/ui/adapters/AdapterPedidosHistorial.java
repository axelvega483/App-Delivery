...
public class AdapterPedidosHistorial extends BaseAdapter {
    private Context context;
    private int layout;
    private PedidosViewModel pedidosViewModel;
    private ArrayList<Pedido> pedidos;

    public AdapterPedidosHistorial(Context context, int layout, ArrayList<Pedido> pedidos, PedidosViewModel pedidosViewModel) {
